...
tabControl = ctk.CTkTabview(window, anchor="nw")

tab_1 = tabControl.add("Sim 1")
tab_2 = tabControl.add("Sim 2")
tab_1.grid_configure(padx=16, pady=16)
tab_2.grid_configure(padx=16, pady=16)
...
# File input
file_input_label = ctk.CTkLabel(master=tab_1,
                                text='Select a file')
file_input_frame = ctk.CTkFrame(master=tab_1,
                                fg_color='transparent',
                                border_width=0)
...
open_loc_opt = ctk.CTkCheckBox(master=tab_1,
...
notify_opt = ctk.CTkCheckBox(master=tab_1,
...
# Progress bar
progress_frame = ctk.CTkFrame(master=tab_1,
                              fg_color="transparent",
                              border_width=0)
...
# Primary button
submit_button = ctk.CTkButton(master=tab_1,
                              text="PROCESS",
                              font=submit_font,
                              height=32,
                              command=process)
...
link_label = ctk.CTkButton(master=tab_1,
...
# TODO: Add second tab & each tab runs functions in different virtual environment
